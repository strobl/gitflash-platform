...
export const ExpenseChart: React.FC = () => {
  ...
  return (
    <div className={`bg-white shadow-[0px_12px_32px_rgba(0,0,0,0.08)] ${isMobile ? 'w-full' : 'flex-1 min-w-[450px]'} p-3 md:p-5 rounded-xl`}>
      <div className="justify-between flex w-full gap-[13px] bg-[#F5F6F7] p-3 md:p-5 rounded-xl">
        <div className="md:w-auto md:flex-1">
          ...
          <p className="text-[#546679] text-[11px] md:text-sm font-medium leading-[14px] md:leading-[1.3] mt-1">
            Kosten, die durch Ihr Team verursacht wurden
          </p>
        </div>
        <div className="flex flex-col whitespace-nowrap leading-[1.3] w-[43px] md:w-auto">
          <div className="text-[#546679] text-[11px] md:text-sm font-medium">
            Gesamt
          </div>
          <div className="text-[#0A2540] text-[15px] md:text-lg font-bold mt-1">
            €400
          </div>
        </div>
      </div>
