...
const TiptapEditor: React.FC<TiptapEditorProps> = ({ content, onChange }) => {
  ...
  return (
    <div className="border border-[#E7E9EC] bg-white min-h-[109px] w-full rounded-lg border-solid overflow-hidden">
      ...
      <EditorContent 
        editor={editor} 
        className="p-3 min-h-[80px] outline-none text-sm text-[#546679]" 
      />
