    ...
    <header className="flex w-full items-center justify-between bg-white sm:px-6 md:px-8 py-2.5 px-[12px] border-b border-gray-200">
      ...
      {!isMobile && (
        <div className="hidden md:flex items-center gap-6">
          <Link
            to="/interviewsdesign"
            className={`text-sm ${isInterviewsActive ? "text-gitflash-primary font-medium" : "text-[#0A2540]"} hover:text-opacity-90`}
          >
            KI Interviews
          </Link>
          <Link
            to="/jobs"
            className="text-sm text-[#0A2540] font-medium hover:text-opacity-90"
          >
            Jobs
          </Link>
          <Link
      ...
      {menuOpen && isMobile && (
        <div className="absolute top-[48px] left-0 right-0 bg-white z-50 shadow-lg animate-fade-in">
          <div className="flex flex-col p-4">
            <Link
              to="/interviewsdesign"
              className={`py-3 text-sm font-medium border-b border-gray-100 ${isInterviewsActive ? "text-gitflash-primary" : "text-[#0A2540]"} hover:text-opacity-90`}
            ...
            <Link
              to="/jobs"
              className="py-3 text-sm text-[#0A2540] font-medium border-b border-gray-100 hover:text-opacity-90"
              onClick={() => setMenuOpen(false)}
            >
              Jobs
            </Link>
