...
export const Hero: React.FC = () => {
  return (
    <section className="w-full max-w-lg px-4 sm:px-6 md:px-0 mt-10 md:mt-16 md:max-w-3xl mx-auto text-center">
      <div className="flex w-full flex-col items-center">
        <div className="flex w-full flex-col">
          ...
          <p className="text-[#546679] text-sm md:text-base font-normal leading-[21px] mt-2.5 md:mt-4">Schließen Sie sich tausenden Akademikern an, die mit GitFlash mit nur einer einzigen Bewerbung Aufträge von Traumkunden erhalten.</p>
        </div>
