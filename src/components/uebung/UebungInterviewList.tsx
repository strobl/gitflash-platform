...
interface UebungInterviewListProps {
  interviews: Interview[];
  onInterviewSelect: (id: string) => void;
}

export const UebungInterviewList: React.FC<UebungInterviewListProps> = ({ 
  interviews,
  onInterviewSelect
}) => {
  ...
  if (interviews.length === 0) {
    return (
      <div className="text-center py-12 bg-[#F5F6F7] rounded-xl">
        <h3 className="text-xl font-semibold mb-2 text-[#0A2540]">Keine Übungsinterviews gefunden</h3>
